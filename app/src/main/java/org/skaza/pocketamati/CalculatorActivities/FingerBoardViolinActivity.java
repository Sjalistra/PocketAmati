...
public class FingerBoardViolinActivity extends ActionBarActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_finger_board_violin);
        setTitle(getResources().getText(R.string.fingerboardLengthViolin));
    ...
    public void Compute(View v) {
        ...
        EditText boardLengthText = (EditText) findViewById(R.id.fingerboardLengthViolinInput);
        if (boardLengthText
                .getText()
                .toString()
                .matches("\\d+(\\.\\d*)?|\\.\\d+")) {
        ...
        fingerboardLengthDouble = (boardLength * 3) / 4;
